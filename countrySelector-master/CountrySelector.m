...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.countrubtnobj.tag = indexPath.row;
    
    [cell.countrubtnobj addTarget:self action:@selector(CountryAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    cell.countrydialcode.text = [tempDic valueForKey:@"dial_code"];
...
-(void)OtherEmotionAction : (UIButton *) btn
{
    ...
    if (searchactive)
    {
        selDic = [[NSDictionary alloc] initWithDictionary:[searchedCountries objectAtIndex:btn.tag]];
    } else {
        selDic = [[NSDictionary alloc] initWithDictionary:[countryArray objectAtIndex:btn.tag]];
    }
