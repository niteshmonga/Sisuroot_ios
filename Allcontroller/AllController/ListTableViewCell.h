...
@property (strong, nonatomic) IBOutlet UILabel *usernamelblobj,*lbl_time,*lbl_like;
@property (strong, nonatomic) IBOutlet UILabel *Liststmtlblobj;
@property (strong, nonatomic) IBOutlet UIButton *favourateBtnobj,*btn_like;
@property (strong, nonatomic) IBOutlet UIButton *commentBtnobj;
@property (strong, nonatomic) IBOutlet UIButton *inviteBtnobj,*btnaddcontact;
@property (strong, nonatomic) IBOutlet UIButton *Overbuttonobj,*add_contact;
