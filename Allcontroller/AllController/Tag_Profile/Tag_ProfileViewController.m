        ...
        if ([[responseDictionary valueForKey:@"status"] integerValue] ==200)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                         [_Profileimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"publicurl"],@"profile_pic/",[[[responseDictionary valueForKey:@"data"] objectAtIndex:0] valueForKey:@"profile_img"]]] placeholderImage:nil];
                        
                      //  [_Profileimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[[[responseDictionary valueForKey:@"data"] objectAtIndex:0] valueForKey:@"profile_img"]]] placeholderImage:nil];
                ...
                else
                {
                     ...
                     [_Tagimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"publicurl"],@"tag_photo/realimage/",[[[responseDictionary valueForKey:@"data"] objectAtIndex:0] valueForKey:@"tagImg"]]] placeholderImage:nil];
                    
                    //[_Tagimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/tag_photo/realimage/%@",[[[responseDictionary valueForKey:@"data"] objectAtIndex:0] valueForKey:@"tagImg"]]] placeholderImage:nil];
