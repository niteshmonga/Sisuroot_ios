...
{
        _requestid= [[imgArr objectAtIndex:btn.tag]valueForKey:@"id"];
        if([[[imgArr objectAtIndex:btn.tag]valueForKey:@"friend_request_send_status"]integerValue]==1)
        {
        }
        else
        {
...
//    {
    ...
    //}
    if(![[[imgArr objectAtIndex:indexPath.row]valueForKey:@"id"] isEqualToString:[[NSUserDefaults standardUserDefaults] valueForKey:@"id"]])
    {
    if( [[[imgArr objectAtIndex:indexPath.row]valueForKey:@"friend_request_send_status"] integerValue]==1)
    {
    ...
    else if([[[imgArr objectAtIndex:indexPath.row]valueForKey:@"myfriend_status"]integerValue]==0)
    {
 ...
 [cell.listprofileimg setImageWithURL:[NSString stringWithFormat:@"%@%@%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"publicurl"],@"tag_photo/",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"tagImg"]] placeholderImage:nil];
    //[cell.listprofileimg setImageWithURL:[NSString stringWithFormat:@"%@%@%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"publicurl"],@"tag_photo/",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"tagImg"]] placeholderImage:nil];
    
    //[cell.listprofileimg setImageWithURL:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/tag_photo/%@",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"tagImg"]] placeholderImage:nil];
  ...
  //  [cell.listprofileimg setImageWithURL:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/tag_photo/%@",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"tagImg"]] placeholderImage:nil];
    ...
    {
          [cell.profileimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"publicurl"],@"profile_pic/",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"profile_pic"]]] placeholderImage:nil];
        
      //  [cell.profileimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"profile_pic"]]] placeholderImage:nil];
...
//    }
    ...
    else
    {
        ...
        //NSString *mainUrl = [NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/EmotionAudio/%@",voicename];
    ...
    if([[methodeDictionary valueForKey:@"name"] isEqualToString:@"getProfileInfo"])
    {
        ...
        else
        {
           ...
           // [_coverimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://ec2-18-216-29-175.us-east-2.compute.amazonaws.com/servicebus/cover_pic/%@",[[responseDictionary valueForKey:@"data"]valueForKey:@"profile_img_two"]]] placeholderImage:nil];
             ...
             [_coverimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"publicurl"],@"cover_pic/",[[responseDictionary valueForKey:@"data"]valueForKey:@"profile_img_two"]]] placeholderImage:nil];
