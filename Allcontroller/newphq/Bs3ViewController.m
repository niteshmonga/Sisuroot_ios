...
- (void)viewDidLoad {
    ...
    NSString *baseURL= [NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/TestAddonQuetion.php?id=%@&scaletype=%@&score=%@", k, j, i];
...
//        NSString *url=@"https://rootapp.epiksolution.org /servicebus/sosnumber.php?id=";
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    NSString *baseURL1= [NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/TestMsgShow.php?scaletype=%@&score=%@&id=%@", j, i, k];
