...
- (void)viewDidLoad {
    ...
    strarr1=[[NSMutableArray alloc]initWithObjects:@"Sisuroot_Tutorial_Design[1].jpg",@"sos.jpg",@"inner-circle.jpg",@"Outer-Circle.jpg",@"chats.jpg",nil];
 
     if ([self.navigationController respondsToSelector:@selector(interactivePopGestureRecognizer)]) {
        self.navigationController.interactivePopGestureRecognizer.enabled = NO;
    }
    
     [self.introcollection registerNib:[UINib nibWithNibName:@"TutorialCollectionViewCell" bundle:nil ]forCellWithReuseIdentifier:@"FirstCollectionViewCell"];
}
