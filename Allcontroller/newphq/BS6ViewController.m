...
- (void)viewDidLoad {
    ...
    strarr1=[[NSMutableArray alloc]initWithObjects:@"9-Home-Settings.jpg",@"test.jpg",@"sos.jpg",@"8-Home-Setting.jpg",@"inner-circle.jpg",@"Outer-Circle.jpg",@"Sisuchat (1).jpg",@"chats.jpg",nil];
