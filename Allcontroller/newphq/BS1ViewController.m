...
- (void)viewDidLoad {
    ...
    if ([_msgcheckstr isEqualToString:@"Testmsg"])
    {
       ...
       _SkipBtnobj.hidden=NO;
        ...
        NSString *baseURL= [NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/TestMsgShow.php?id=%@&scaletype=%@&score=%@", k, j, i];
    ...
    else
    {
       ...
       NSString *url=@"https://rootapp.epiksolution.org /servicebus/sosnumbernew.php?id=";
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
   ...
   // URLneme=url;
    if ([urlString isEqualToString:@"https://rootapp.epiksolution.org /servicebus/backtohome.php"]) {
    ...
    else if ([urlString isEqualToString:@"https://rootapp.epiksolution.org /servicebus/backtohome.php"]){
