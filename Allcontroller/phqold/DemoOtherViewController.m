...
- (void)viewDidLoad {
    ...
    checkstr=@"https://rootapp.epiksolution.org /servicebus/thankyou.php";
    if ([_typeString isEqualToString:@"demo1"])
    {
        ...
        NSString *url=@"https://rootapp.epiksolution.org /servicebus/Demographicform_2_therapy.php?id=";
    ...
    else if([_typeString isEqualToString:@"demo2"])
    {
        _headerLbl.text=@"Tell us about yourself";
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
        NSString *url=@"https://rootapp.epiksolution.org /servicebus/Demographicform_3_teens.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
    else if([_typeString isEqualToString:@"demo3"])
    {
        _headerLbl.text=@"Tell us about yourself";
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
        NSString *url=@"https://rootapp.epiksolution.org /servicebus/Demographicform_4_PPD.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
    ...
    else if([_typeString isEqualToString:@"Quiz1"])
    {
        ...
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
       // NSString *url=@"https://rootapp.epiksolution.org /DairyQuiz.php?id=";
        NSString *url=@"https://rootapp.epiksolution.org/rootadmin/DairyQuiz.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
    else if([_typeString isEqualToString:@"Quiz2"])
    {
        ...
        _headerLbl.text=@"Quiz Time";
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
        NSString *url=@"https://rootapp.epiksolution.org/rootadmin/VegetableQuiz.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
    else if([_typeString isEqualToString:@"Quiz3"])
    {
        ...
        _headerLbl.text=@"Quiz Time";
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
        NSString *url=@"https://rootapp.epiksolution.org/rootadmin/ProteinFoodsQuiz.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
    else if([_typeString isEqualToString:@"Quiz4"])
    {
       _footerlbl.hidden=NO;
        ...
        _headerLbl.text=@"Quiz Time";
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
        NSString *url=@"https://rootapp.epiksolution.org/rootadmin/FruitQuiz.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
    else if([_typeString isEqualToString:@"Quiz5"])
    {
        ...
        _headerLbl.text=@"Quiz Time";
        NSString *i=[[NSUserDefaults standardUserDefaults] valueForKey:@"id"];
        NSString *url=@"https://rootapp.epiksolution.org/rootadmin/GrainsQuiz.php?id=";
        NSString *url1=[url stringByAppendingString:i];
        [_webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url1]]];
    }
}
