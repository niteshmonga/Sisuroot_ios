//
//  BriefstateCollectionViewCell.h
//  Root
//
...
@interface BriefstateCollectionViewCell : UICollectionViewCell
...
@property (strong, nonatomic) IBOutlet UIProgressView *progessview;
@end
