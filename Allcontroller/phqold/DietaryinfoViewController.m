...
#import "DietaryinfoViewController.h"
...
@interface DietaryinfoViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>
{
    NSMutableArray *Arr1;
    NSMutableArray *Arr2;
    NSMutableArray *Arr3;
...
@implementation DietaryinfoViewController
...
- (void)viewDidLoad {
    ...
    Arr1=[[NSMutableArray alloc]initWithObjects:@"Question 1/16",@"Question 2/16",@"Question 3/16",@"Question 4/16",@"Question 5/16",@"Question 6/16",@"Question 7/16",@"Question 8/16",@"Question 9/16",@"Question 10/16",@"Question 11/16",@"Question 12/16",@"Question 13/16",@"Question 14/16",@"Question 15/16",@"Question 16/16",@"Thank You",nil];
    ...
    [self.introcollection registerNib:[UINib nibWithNibName:@"PPDTestCCollectionViewCell" bundle:nil ]forCellWithReuseIdentifier:@"FirstCollectionViewCell"];
