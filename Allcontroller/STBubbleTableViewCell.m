...
{
	self.bubbleView.image = [[UIImage imageNamed:[NSString stringWithFormat:@"Bubble-0@2x.png", (long)color]] resizableImageWithCapInsets:UIEdgeInsetsMake(12.0f, 15.0f, 16.0f, 18.0f)];
}
