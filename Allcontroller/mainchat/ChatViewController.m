    ...
    else
    {
        ...
        if([[_detail1 valueForKey:@"img_status"] integerValue]==1)
        {
            ...
            else
            {
                ...
                //[_userimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[_detail1  valueForKey:@"friend_img"]]] placeholderImage:nil];
                ...
                //[_Gimg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[_detail1  valueForKey:@"friend_img"]]] placeholderImage:nil];
