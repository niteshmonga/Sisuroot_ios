     ...
     if (tableView== chattableview)
    {
        ...
        else
        {
            if([[[imgArr objectAtIndex:indexPath.row] valueForKey:@"img_status"] integerValue]== 1)
            {
                 ...
                 //[cell.Userimg setImageWithURL:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[[imgArr objectAtIndex:indexPath.row]valueForKey:@"friend_img"]] placeholderImage:nil];
            }
    ...
    if (tableView== _therapisttableview)
    {
        ...
        else
        {
            if([[[imgArr2 objectAtIndex:indexPath.row] valueForKey:@"img_status"] integerValue]== 1)
            {
               ...
               // [cell.Userimg setImageWithURL:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[[imgArr2 objectAtIndex:indexPath.row]valueForKey:@"friend_img"]] placeholderImage:nil];
            }
        ...
        else
        {
            ...
            else
            {
                if([[[imgArr1 objectAtIndex:indexPath.row] valueForKey:@"img_status"] integerValue]== 1)
                {
                  ...
                  //  [cell.Userimg setImageWithURL:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[[imgArr1 objectAtIndex:indexPath.row]valueForKey:@"friend_img"]] placeholderImage:nil];
                }
...
-(void)mhpinfoAction  : (UIButton *) btn
{
    ...
    else
    {
        if([[[imgArr2 objectAtIndex:btn.tag] valueForKey:@"img_status"] integerValue]== 1)
        {
            ...
            //[_mhpprofileimg setImageWithURL:[NSString stringWithFormat:@"https://rootapp.epiksolution.org /servicebus/profile_pic/%@",[[imgArr2 objectAtIndex:btn.tag]valueForKey:@"friend_img"]] placeholderImage:nil];
        }
