...
//    [gai trackerWithTrackingId:@"UA-112860070-1"];
   ...
   // gai.logger.logLevel = kGAILogLevelVerbose;
    ...
    {
        //        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"“You should connect with wifi for optimal use." delegate:nil cancelButtonTitle:@"ok" otherButtonTitles:nil, nil];
        //
        //        alert.tag=2000;
        //        [alert show];
    }
