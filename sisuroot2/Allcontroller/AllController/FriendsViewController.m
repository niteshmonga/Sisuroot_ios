    ...
    for(int i=0; i<nPeople; i++)
    {
        
         {
            ...
            for (CFIndex j=0; j < ABMultiValueGetCount(multi); j++)
            {
                ...
                {
                    [contacName setObject:@"" forKey:@"mobile"];
                }
             }
...
//                }
            ...
            case 2:
            {
                if ([str2 integerValue] == 1 || [strsearch2 integerValue] == 1)
                {
                    [self.view showActivityViewWithLabel:@"Loading"];
...
//[23456789][0-9]{6}([0-9]{3})
    ...
    else if (_PhoneTF.text.length < 10 || _PhoneTF.text.length > 10)
    {
    ...
    else if (_PhoneTF.text.length == 10)
    {
        ...
        else if (![test evaluateWithObject:_PhoneTF.text])
        {
