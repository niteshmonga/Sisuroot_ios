//
//  SectionCvoicetestViewController.h
//  Root
//
//  Created by BRIJESH KUMAR on 21/10/18.
...
@interface SectionCvoicetestViewController : UIViewController
...
@property (nonatomic, strong) IBOutlet NSString *voicestr3;
@property (nonatomic, strong) IBOutlet NSString *voicestr4;
@property (nonatomic, strong) IBOutlet NSString *questionstr3;
@property (nonatomic, strong) IBOutlet NSString *Questionstr4;
@end
