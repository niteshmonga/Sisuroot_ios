...
@interface SectionBvoicetestViewController : UIViewController
...
@property (nonatomic, strong) IBOutlet NSString *voicestr2;
@property (nonatomic, strong) IBOutlet NSString *questionstr2;
