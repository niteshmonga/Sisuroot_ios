...
@objc open class ScrollableGraphView: UIScrollView, UIScrollViewDelegate, ScrollableGraphViewDrawingDelegate {
    ...
    @IBInspectable open var backgroundFillColor: UIColor = UIColor(red: 0/255.0, green: 73/255.0, blue: 146/255.0, alpha: 1.0)//UIColor.white
   ...
   // @IBInspectable open var rangeMax: Double = 10
     @IBInspectable open var rangeMax: Double = 30
